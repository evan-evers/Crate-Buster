...
static const int BULLET_ERRATIC_DMG = 6;
static const int BULLET_BOUNCER_DMG = 15;
...
void updateBullets(void) {
	...
	while(bullet != NULL) {
		...
		if (bullet->type != WT_ENEMY) {
			...
			if (checkIntersection(bullet->collider, player->collider)) {
